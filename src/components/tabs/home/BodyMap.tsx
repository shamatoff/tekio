// The anatomical figure's geometry — the one silhouette every muscle map in
// the app is drawn on. GapMap (Home and the Adaptations drill-down, roadmap
// 031) owns the rendering; this module is paths only, so the two reads can
// never disagree about where a muscle is. The old three-colour BodyMap
// component that lived here went with roadmap 031 unit 4.
